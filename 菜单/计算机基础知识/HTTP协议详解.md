...
<img src="https://i.loli.net/2020/09/21/njheAKdZ8QB4WtV.png" alt="img" style="zoom:150%;" />
...
![img](https://i.loli.net/2020/09/21/HfhYo4JLsQUrdBq.png)
...
![img](https://i.loli.net/2020/09/21/EFpnPRLf4hW5Yb8.png)
...
![img](https://i.loli.net/2020/09/21/qQZvngWdpkhc8SE.png)
...
![img](https://i.loli.net/2020/09/21/h2OgBmRwbdE6WIX.jpg)



![img](https://i.loli.net/2020/09/21/ocFIhrZOWleD1jN.png)

​        请求头里面的内容举个例子：这个length表示请求体里面的数据长度，其他的请求头里面的这些键值对，陆续我们会讲的，大概知道一下就可以了，其中有一个user-agent，算是需要你记住的吧，就是告诉你的服务端，我是用什么给你发送的请求。

![img](https://i.loli.net/2020/09/21/tdp5gWPOFsvKRy6.png)

以京东为例，看一下user-agent

![img](https://i.loli.net/2020/09/21/j4zeWUyp6KLNiAT.png)



![img](https://i.loli.net/2020/09/21/Hh7du6f2TcPLKmp.png)



　看一个爬虫的例子，爬京东的时候没问题，但是爬抽屉的时候必须带着user-agent，因为抽屉对user-agent做了判断，来判断你是不是一个正常的请求，算是反扒机制的一种。

![img](https://i.loli.net/2020/09/21/GMK6bvTXFHfNaLI.png)
...
![img](https://i.loli.net/2020/09/21/PS1JavYk7IVGoDe.jpg)



![img](https://i.loli.net/2020/09/21/wN6n4JiSPD72IxV.png)